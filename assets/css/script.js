...
const animeData = [
    {
        ...
        likes: 0,
        dislikes: 0,
        totalLikes: 0,     // New property for total likes
        totalDislikes: 0,  // New property for total dislikes
    },
...
function updateAnimeSection(index) {
    ...
    if (animeSection && anime) {
        ...
        if (likeButton && dislikeButton && likesCounter && totalLikes && totalDislikes) {
            ...
            likesCounter.textContent = `Likes: ${anime.likes - anime.dislikes}`; // Update to display likes - dislikes
